...
> This Plugin requires [MyMail Newsletter Plugin for WordPress](https://evp.to/mymail?utm_campaign=wporg&utm_source=AmazonSES+integration+for+MyMail)

Uses Amazon's Simple Email Service (SES) to deliver emails for the [MyMail Newsletter Plugin for WordPress](https://evp.to/mymail?utm_campaign=wporg&utm_source=AmazonSES+integration+for+MyMail).
...
= 1.1.7 =
* updated notifications, tested with WP 4.7
